...
import { findAllRequests, findOneRequest, updateRequest, findEmployeeRequest } from "../controllers/requestController.js";

const router = express.Router();
router.get("/", findAllRequests);
router.get("/:id", findOneRequest);
router.get("/employee/:id", findEmployeeRequest);
