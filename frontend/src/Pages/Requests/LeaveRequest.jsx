...
const LeaveRequest = () => {
    ...
    useEffect(() => {
        ...
        axios.get('http://localhost:5500/employee')
            .then(response => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            await axios.post("http://localhost:5500/leave", { ...formData, employee: id, department, type: "Congé" });
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-4">
                        ...
                        >
                            ...
                            {/* Filter out the current employee from the list of substitutes */}
                            {employees.filter(emp => emp._id !== id).map(employee => (
